...
Eine sinvolle Operation einer Gruppe sollte mit den Gruppenoperationen
kompatibel sein. 
...
Weise Äquivalenklassen auf einer Manigfaltigkeit, welche gerade diejenigen
...
\end{equation}
Der Orbitraum $M/G$ selbs ist offensichtlich diffeomorph zu $\Reals$. Der
...
Sei $M,N$, $m$ bzw. $n$-dimensionale, orientierbare Manigfaligkeiten, mit $m\geq
n$.
...
\end{equation}
für fast alle $p\in N$ und $F$ ist messbar. Es gilt
\begin{equation}
...
ausgestattet mit einer $G$-invarianten (pseudo-)riemanschen Metrik $g$. 
