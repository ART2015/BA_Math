...
\end{equation}
Orbit von $x$. Als \emph{Orbitraum} bezeichnen wir die Menge aller Orbits
\begin{equation}
M/G=\{[x]=G.x\,|\,x\in M\}\,,
\end{equation}
\end{definition}
zusammen mit der Quotiententopologie, der gröbsten Topologie für die die kanonische Projektion
...
\end{equation}
Der Orbitraum $M/G$ ist diffeomorph zu $\Reals$. Der Zylinder lässt sich
...
folgendes \begin{beispiel}[Ein nicht Hausdorfscher Quotient
...
$f:E\to \Reals$, $G$-invariant und integrierbar. Eine Tivialisierung einer
